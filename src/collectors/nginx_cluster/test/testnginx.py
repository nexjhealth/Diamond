...
class TestNginxNodeCollector(CollectorTestCase):

    def setUp(self):
        config = get_collector_config('NginxNodeCollector', {})

        self.collector = NginxNodeCollector(config, None)

    def test_import(self):
        self.assertTrue(NginxNodeCollector)
